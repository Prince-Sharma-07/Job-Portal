...
export default function SignIn() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      // error ka type kuch bhi ho skta hai , agar wo throw keyword se direct throw hua h to usme message key nahi hogi , else if vo instance of the Error hai to message key available hogi
      alert(err.message);
    }
  }
